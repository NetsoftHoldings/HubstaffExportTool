  ...
  protected
    ...
    def parsed_options?
      ...
      @opts_parser = OptionParser.new do |opts|
        ...
        opts.separator  "       Start and stop time should be in the following format.  YYYY-MM-DDThh:mmZ"
        opts.separator  "       where Z means that the time is in UTC or it can be a timezone offset"
        opts.separator  "       - ex.  2015-06-01T04:00Z  or 2015-06-01T00:00-0400 or 2015-06-01T03:00+0100"
